...
- Des **données de nature très différentes** :
    ...
    - Données en ligne (webscraping)
    - Données textuelles et non structurées
    - Et encore d'autres données : images, sons, données localisées
...
### Quelques exemples - images satellites 
...
##  {#pageDeFin .titreTransparent .unnumbered .backgroundPageFinale}

:::: {.columns .coordonneesFinales}
 
::: {.column .coordonnees width=23%}
- Nicolas TOULEMONDE
- Laboratoire d'innovation en data-science (SSPLab)
- Direction de la méthodologie, de la coordination statistique et internationale (DMCSI)
:::
 
::: {.column .droite width=87%}
:::
